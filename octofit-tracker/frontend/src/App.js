    ...
    <Router>
      <nav className="navbar navbar-expand-lg navbar-dark bg-primary mb-4">
        <div className="container-fluid">
          <Link className="navbar-brand fw-bold" to="/">
            <img src="/octofitapp-small.png" alt="Octofit Logo" style={{height: '32px', marginRight: '12px', verticalAlign: 'middle'}} />
            Octofit Tracker
          </Link>
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/" element={<div className="text-center mt-5"><h1 className="display-4 fw-bold">Bienvenue sur Octofit Tracker !</h1><p className="lead">Votre application fitness collaborative</p></div>} />
        </Routes>
      </div>
    </Router>
  );
